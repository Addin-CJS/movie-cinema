...
--------------------------------------------------------
 ...
 NOCOMPRESS LOGGING
  ...
  TABLESPACE "USERS" ;
REM INSERTING into SYSTEM.TICKET
SET DEFINE OFF;
--------------------------------------------------------
--  DDL for Index SYS_C008399
--------------------------------------------------------

  CREATE UNIQUE INDEX "SYSTEM"."SYS_C008399" ON "SYSTEM"."TICKET" ("TICKET_ID")
...
--------------------------------------------------------
  ...
  ALTER TABLE "SYSTEM"."TICKET" MODIFY ("TICKET_ID" NOT NULL ENABLE);
  ALTER TABLE "SYSTEM"."TICKET" ADD PRIMARY KEY ("TICKET_ID")
